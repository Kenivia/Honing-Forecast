...
pub struct RawData {
    ...
    pub EVENT_NORMAL_EXTRA_CHANCE: [[f64; 25]; 3],
    pub EVENT_ARTISAN_MULTIPLIER: [[f64; 25]; 3],
    ...
    pub NORMAL_VAMBRACE_COST: [[f64; 25]; 7],
    pub NORMAL_WEAPON_UNLOCK: [[f64; 25]; 7],
    pub NORMAL_ARMOR_UNLOCK: [[f64; 25]; 7],
    pub NORMAL_VAMBRACE_UNLOCK: [[f64; 25]; 7],
    pub SPECIAL_LEAPS_COST: [[i64; 25]; 3],
...
#[allow(non_snake_case)]
pub struct Data {
    pub EVENT_NORMAL_EXTRA_CHANCE: Vec<Vec<f64>>,
    pub EVENT_ARTISAN_MULTIPLIER: Vec<Vec<f64>>,
    ...
    pub NORMAL_VAMBRACE_COST: Vec<Vec<f64>>,
    pub NORMAL_WEAPON_UNLOCK: Vec<Vec<f64>>,
    pub NORMAL_ARMOR_UNLOCK: Vec<Vec<f64>>,
    pub NORMAL_VAMBRACE_UNLOCK: Vec<Vec<f64>>,
...
impl From<RawData> for Data {
    fn from(r: RawData) -> Self {
        ...
        Self {
            EVENT_NORMAL_EXTRA_CHANCE: to_vec2d(&r.EVENT_NORMAL_EXTRA_CHANCE),
            EVENT_ARTISAN_MULTIPLIER: to_vec2d(&r.EVENT_ARTISAN_MULTIPLIER),
            ...
            NORMAL_CHANCES: to_vec2d(&r.NORMAL_CHANCES),
            ...
            NORMAL_VAMBRACE_COST: to_vec2d(&r.NORMAL_VAMBRACE_COST),
            NORMAL_WEAPON_UNLOCK: to_vec2d(&r.NORMAL_WEAPON_UNLOCK),
            NORMAL_ARMOR_UNLOCK: to_vec2d(&r.NORMAL_ARMOR_UNLOCK),
            NORMAL_VAMBRACE_UNLOCK: to_vec2d(&r.NORMAL_VAMBRACE_UNLOCK),
