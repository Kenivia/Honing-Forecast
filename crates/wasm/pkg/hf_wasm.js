 ...
 * @returns {any}
 */
export function optimize_average_wrapper(input) {
    const ret = wasm.optimize_average_wrapper(input);
    return ret;
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_postMessage_622de22478498969 = function(arg0) {
        postMessage(arg0);
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('hf_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
