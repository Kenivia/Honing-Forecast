use crate::engine::v11::core::JUICE_CROSSOVER_MULTIPLIER;
use crate::engine::v11::core::SPECIAL_CROSSOVER_MULTIPLIER;
...
impl SolverStateBundle {
    ...
    pub fn perform_crossover(&mut self) {
        ...
        if self
            .rng
            .random_bool(self.temp / INIT_TEMP * SPECIAL_CROSSOVER_MULTIPLIER)
        {
            self.state_bundle
                .special_state
        ...
        let random_indices = (0..self.state_bundle.upgrade_arr.len()).choose_multiple(
            &mut self.rng,
            (self.temp / INIT_TEMP
                * JUICE_CROSSOVER_MULTIPLIER
                * (self.state_bundle.upgrade_arr.len() - 1) as f64)
                .ceil() as usize,
        );
