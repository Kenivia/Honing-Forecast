  ...
  <div v-if="!upgrade.is_normal_honing">
    ...
    <div class="input-row grid-4">
      ...
      <label
        ...
        class="check-label"
      >
        <input type="checkbox" v-model="next_free" @change="write_progress" />
        Next free (Chisel)
      </label>
      <label
        ...
        class="check-label"
      >
        <input type="checkbox" v-model="next_big" @change="write_progress" />
        Naber's Awl
      </label>
    </div>
  </div>
