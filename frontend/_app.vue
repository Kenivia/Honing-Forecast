...
import { get_icon_path } from "./_utils/_helpers";
import { CharProfile } from "./_stores/character_profile";
import { debounced_write_roster_config, useRosterStore } from "./_stores/roster_config";
import { useMediaIsNarrow } from "./_utils/window_size";
import { fetch_callback, useTimedFetch } from "./_utils/market_data_fetcher";
            ...
            <nav class="hf-top-nav">
                <div class="hf-page-header-row" style="width: 100%">
                    ...
                    <router-link to="/roster-setup">
                        <div class="hf-header-button" :class="{ selected: route.path == '/roster-setup' }">
                            Roster setup
                        </div>
                    </router-link>
                    <router-link to="/market-mats">
                        <div class="hf-header-button" :class="{ selected: route.path == '/market-mats' }">
                            Market & Mats
                        </div>
                    </router-link>
