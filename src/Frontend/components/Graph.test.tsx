...
describe("Graph component (unit tests)", () => {
    ...
    test('shows "Nothing to plot, tick an upgrade!" when counts are missing and hasSelection false', () => {
        render(<Graph labels={baseLabels} counts={null} mins={null} maxs={null} hasSelection={false} isLoading={false} width={300} height={150} />)
    ...
    test("clicking a legend button toggles its visibility (opacity change)", async () => {
        ...
        render(<Graph labels={baseLabels} counts={counts} mins={[0, 0, 0, 0, 0, 0, 0]} maxs={[10, 10, 10, 10, 10, 10, 10]} width={400} height={200} />)
