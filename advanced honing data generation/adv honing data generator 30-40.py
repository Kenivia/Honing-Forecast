...
def _single_sim(rng_random):
    BALL_THRESH = (0.125,0.25+0.125,0.125+0.25+0.125,0.25+0.125+0.25+0.125, 0.125+0.25+0.125+0.25+0.125,0.125+0.125+0.25+0.125+0.25+0.125)  # cumulative thresholds -> 1,2,3,4
    BIGBALL_THRESH = (0.2,0.4,0.6,0.8,1)
    ...
    while cur_xp < 1000:
        ...
        if cur_balls >= 6:
            ...
            if next_BIG:
                next_BIG = False
                if r2 < BIGBALL_THRESH[0]:
                    # case 1
                    rolled_xp *= 7
                elif r2 < BIGBALL_THRESH[1]:
                    # case 2
                    rolled_xp *= 5
                elif r2 < BIGBALL_THRESH[2]:
                    # case 3
                    rolled_xp += 80
                    cur_balls = 6
                elif r2 < BIGBALL_THRESH[3]:
                    # case 4
                    rolled_xp += 30
                    next_free = True
                elif r2 < BIGBALL_THRESH[4]:
                    cur_xp += rolled_xp
                ...
                if r2 < BALL_THRESH[0]:
                    ...
                    rolled_xp += 30
                    cur_balls = 6
                elif r2 < BALL_THRESH[3]:
                    # case 4
                    rolled_xp += 10
                    next_free = True
                elif r2 < BALL_THRESH[4]:
                    # case 4
                    cur_balls = 6
                    next_BIG = True
                elif r2 < BALL_THRESH[5]:
                    cur_xp += rolled_xp
...
if __name__ == '__main__':
    ...
    import json
    import time
    with open("30 or 40 adv honing data " +str(time.time()) + ".txt","w") as file:
